...
public interface iCashierService {
    ...
    void sellProducts(Cashier cashier, PhoneAndAccessoriesStore store, Customer customer) throws StaffNotAuthorizedException, InsufficientFundException, IOException;
}
